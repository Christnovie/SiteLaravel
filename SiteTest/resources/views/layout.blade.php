    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="displayArticles"class="nav-link">Shop</a></li>
                ...
                <li class="nav-item"><a href="client" class="nav-link"style="color:#FC05CB">S'inscrire</a></li>
                <?php else : ?>
            <!-- Display the button useful for logout-->
                <li class="nav-item"><a href="logout"class="nav-link">Voir nos Clients </a></li>
                <?php endif; ?>

                <li class="nav-item cta cta-colored"><a href="panier" class="nav-link"><span class="icon-shopping_cart"></span>[]</a></li>
